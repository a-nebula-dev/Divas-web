...
// -----------------------------------------------------------------------------
import Link from "@/components/legacy/Link";
...
// -----------------------------------------------------------------------------
import MoodboardService from "@/services/MoodboardService.jsx";
// -----------------------------------------------------------------------------
import {
  MoodboardEditorContextProvider,
  useMoodboardEditorController,
...
function _Content({ moodboardModel }) {
  ...
  if (
    !editorController.moodboardModel ||
    editorController.moodboardModel._id != moodboardModel?._id
  ) {
    if (moodboardModel) {
        ...
        <div className={styles.editorContentContainer}>
          <MoodboardCanvas
            ...
            xxx_OnCanvasHasChanged={() => {
              ...
              if (is_empty) {
                if (
                  _saveDraftSpanRef.current &&
                  _saveDraftSpanRef.current.innerText
                ) {
                  _saveDraftSpanRef.current.innerText = "Save Draft";
                }
              } else {
