...
// -----------------------------------------------------------------------------
import UserInfo from "@/components/legacy/User/Profile/UserInfo";
import {
  CategoriesBar,
  CategoriesBarItem,
} from "@/components/legacy/User/Profile/CategoriesBar";
// -----------------------------------------------------------------------------
...
function UserProfile({ userModel }) {
  ...
  const categories_info = [
    {
      title: "Moodboards",
      element: <MoodboardGrid userModel={userModel} />,
      pred: () => {
        return true;
      },
    },
    {
      title: "Drafts",
      element: <LikesGrid userModel={userModel} />,
      pred: () => {
        return loggedUser && loggedUser._id == userModel._id;
      },
    },
    {
      title: "Liked",
      element: <DraftsGrid userModel={userModel} />,
      pred: () => {
        return true;
      },
    },
    {
      title: "Following",
      element: <FollowersGrid userModel={userModel} />,
      pred: () => {
        return true;
      },
    },
    {
      title: "Followers",
      element: <FollowingGrid userModel={userModel} />,
      pred: () => {
        return true;
      },
    },
  ...
  return (
    <>
      ...
      <Suspense>{categoryComponent}</Suspense>
    </>
  );
}
