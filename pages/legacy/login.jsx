...
import LoginUserForm from "@/components/legacy/User/Forms/LoginUserForm";
// -----------------------------------------------------------------------------
  ...
  return (
    <>
      <UserLoggedContext
        ...
        redirectTo={PageUrls.UserOwnProfile}
      >
        {/*  */}
          ...
          <div className={styles.contentContainer}>
            ...
            <div className={styles.bottomContainer}>
              <div className={styles.linksContainer}>
                <ul>
                  <li>
                    <Link href={PageUrls.DocsHelp}>Help</Link>
                  </li>
                  <li>
                    <Link href={PageUrls.DocsTerms}>Terms</Link>
                  </li>
                  <li>
                    <Link href={PageUrls.DocsPrivacy}>Privacy</Link>
                  </li>
                  <li>
                    <Link href={PageUrls.DocsCopyright}>Copyright Policy</Link>
                  </li>
                </ul>
              </div>
